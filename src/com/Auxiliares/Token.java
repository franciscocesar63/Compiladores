...
public class Token {
    ...
    public static final int PONTOFLUTUANTE = 22;
    ...
    public static final int DDIR = 8;
    public static final int INC = 9;
    public static final int DEC = 10;
    public static final int SUME = 11;
    public static final int SUBE = 12;
